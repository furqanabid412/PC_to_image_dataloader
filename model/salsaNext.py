# Fork from SalsaNext
# Support and cite their paper 'SalsaNext: Fast, Uncertainty-aware Semantic Segmentation of LiDAR Point Clouds for Autonomous Driving'
...
class SalsaNext(nn.Module):
    def __init__(self, num_channels, num_classes):
        ...
        self.downCntx = ResContextBlock(num_channels, 32)
        ...
        self.logits = nn.Conv2d(32, 32, kernel_size=(1, 1))
        # self.logits = nn.Conv2d(32, num_classes, kernel_size=(1, 1))
